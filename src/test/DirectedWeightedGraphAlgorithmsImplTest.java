...
import api.NodeData;
import maincodes.DirectedWeightedGraphAlgorithmsImpl;;
...
class DirectedWeightedGraphAlgorithmsImplTest {
    ...
    public DirectedWeightedGraph resetGraph(){
        DirectedWeightedGraph graph = Ex2.take_new_graph("data/G1.json");
    ...
    void save() {
        ...
        assertTrue(this.algoGraph.save("data/G1.json"));
        graph = resetGraph();
    ...
    @Test
    void load() {
        this.algoGraph.load("data/G1.json");
        assertNotNull(this.algoGraph.getGraph().getNode(16));
        this.algoGraph.load("data/G2.json");
        assertNotNull(this.algoGraph.getGraph().getNode(30));
        this.algoGraph.load("data/G3.json");
